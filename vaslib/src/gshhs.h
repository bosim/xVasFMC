/*	$Id: gshhs.h,v 1.2 2008-01-31 18:27:26 alex Exp $
 *
...
struct	GSHHS_POINT {	/* Each lon, lat pair is stored in micro-degrees in 4-byte integer format */
    ...
    inline double lat() const { return y * 1.0e-6; }
    inline double lon(bool) const { return (x > 180000000) ? (x * 1.0e-6) - 360.0 : x * 1.0e-6; }
};
#endif	/* _GSHHS */
